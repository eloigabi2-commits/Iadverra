---
name: design-style
description: Use this skill for any frontend/UI work — building or improving websites, web apps, landing pages, dashboards, or components (buttons, forms, cards, navbars, modals); styling existing UI; or applying specific design aesthetics. Works with React, Vue, Next.js, Svelte, vanilla JS, Tailwind, and styled-components. Triggers on "frontend", "UI", "UX", "design", "interface", "styling", or aesthetic adjectives like "beautiful", "modern", "professional", "clean", "brutalist", "cyberpunk", "dark", "minimalist". Automatically retrieves the matching design system prompt (Neo-brutalism, Modern Dark, Bauhaus, Cyberpunk, Material, and more) for distinctive production-grade UI instead of generic output. Activate proactively for ANY frontend/UI request.
